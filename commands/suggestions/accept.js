...
module.exports = new Command({
    ...
    run: async ({ client, message, args }) => {
        ...
        try {
            ...
            // Update data
            const acceptEmbed = suggestedEmbed.embeds[0]
                .setColor(client.colors.green)
                .setFooter({ text: `Accepted by ${message.author.tag}`, iconURL: message.author.displayAvatarURL({ dynamic: true }) })
            ...
            // Success message
            client.successEmbed(message, `The suggestion has been accepted.`);
